...
public class MarkerAddActivity extends AppCompatActivity {
    ...
    public void sendMarker() {
        ...
        if (markerTitle == null || markerText == null || markerCategoryId == null) {
            ...
            Marker marker = cz.uhk.stex.model.Marker.builder()
                    .withId(null)
            ...
            Database.addMarker(markerGroupId, marker).success(new Promise.SuccessListener<cz.uhk.stex.model.Marker, Object>() {

                @Override
                public Object onSuccess(cz.uhk.stex.model.Marker result) {
